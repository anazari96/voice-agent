...
exports.textToSpeechStream = exports.validateElevenLabsApiKey = void 0;
 ...
 */
const readErrorStream = async (stream) => {
...
const validateElevenLabsApiKey = async () => {
    ...
    try {
        ...
        const response = await axios_1.default.get('https://api.elevenlabs.io/v1/user', {
            headers: {
        ...
        if (status === 401) {
            ...
            if (error.response?.data) {
                try {
                    if (error.response.data instanceof stream_1.Readable || (typeof error.response.data === 'object' && error.response.data.pipe)) {
...
exports.validateElevenLabsApiKey = validateElevenLabsApiKey;
const textToSpeechStream = async (text) => {
    ...
    try {
        ...
        try {
            await axios_1.default.get('https://api.elevenlabs.io/v1/user', {
                headers: {
                    'xi-api-key': ELEVENLABS_API_KEY
                },
